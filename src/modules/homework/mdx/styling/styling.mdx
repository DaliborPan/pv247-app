...
import DESIRED_RESULT from './desired-result.png';
import DESIRED_RESULT_SCROLLED from './desired-result-scrolled.png';
import DESIRED_RESULT_TABLET from './desired-result-tablet.png';
import DESIRED_RESULT_MOBILE from './desired-result-mobile.png';
...
<HomeworkGeneralInfo slug="styling" />
...
<MdxImage src={DESIRED_RESULT} />

### Desktop scrolled down

<MdxImage src={DESIRED_RESULT_SCROLLED} />

### Tablet

<MdxImage src={DESIRED_RESULT_TABLET} />

### Mobile

<MdxImage src={DESIRED_RESULT_MOBILE} />
