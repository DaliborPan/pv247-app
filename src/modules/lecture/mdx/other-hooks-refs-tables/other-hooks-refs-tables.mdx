...
<MdxComment>
  ...
  yourself — see the React Compiler section at the end. We still go through it,
  because you need to understand *what* the compiler automates and *why* React
  re-renders in the first place, and because you will meet manual memoization in
  many existing codebases.
</MdxComment>
...
<MdxComment>
  This course uses TanStack Table v8. Version 9 was released in August 2026 and
  brings a different, tree-shakable architecture, so make sure you are reading
  the v8 documentation — the examples above will not work as-is against the v9
  API.
</MdxComment>
