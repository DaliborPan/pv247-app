...
<MdxComment>
  ...
  meet manual memoization in every existing codebase.
</MdxComment>
...
For details on enabling and configuring it, see the [React Compiler documentation](https://react.dev/learn/react-compiler).
...
<MdxImage
  src={PROP_DRILLING}
  alt="A language setting passed through several component levels to a nested component that needs it"
/>
