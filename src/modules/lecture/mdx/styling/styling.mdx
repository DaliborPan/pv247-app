...
Teaching UI standards could be a standalone course. We want to motivate you to build systems that look good and are easy to use, therefore we want to at least touch upon some rules which help you to achieve that. We also provide sources for further reading.

It is not about learning one design system (such as [Material Design](https://m3.material.io/) or [Glassmorphism](https://www.nngroup.com/articles/glassmorphism/)) but about general principles.
...
Consistency - spacing, colors etc. 

color paletes - e.g. http://coolors.co/

fonts - e.g. [Google fonts](https://fonts.google.com/)

accessibility (addressed later)

## Agentic development

Use skills e.g. https://vercel.com/design/guidelines
